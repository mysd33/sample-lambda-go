...
// TODO: MongoDB DriverのOpenTelemetry対応
// https://pkg.go.dev/go.opentelemetry.io/contrib/instrumentation/go.mongodb.org/mongo-driver
// 対応前に、MongoDBのV2ドライバーへの移行も必要
...
const (
	...
	DOCUMENTDB_USERNAME_NAME = "docdb_smconfig_username"
	DOCUMENTDB_PASSWORD_NAME = "docdb_smconfig_password"
